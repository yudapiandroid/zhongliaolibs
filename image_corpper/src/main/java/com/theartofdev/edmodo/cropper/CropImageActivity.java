...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
     ...
     * 启动 裁减
     *
     * @param activity  会回调该activity的 result
     * @param source 需要裁减的文件
     * @param corp 裁减结果
     */
    public static void startActivity(Activity activity, Uri source, Uri corp){
        CropImage.activity(source,corp)
