...
public final class CropImage {
     ...
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 0x0022;
    ...
    public static ActivityBuilder activity(@NonNull Uri uri,Uri outPut) {
        if (uri == null || uri.equals(Uri.EMPTY)) {
            throw new IllegalArgumentException("Uri must be non null or empty");
        }
        return new ActivityBuilder(uri,outPut);
    }
    ...
    public static final class ActivityBuilder {
        ...
        private ActivityBuilder(@NonNull Uri source,Uri outUri) {
            mSource = source;
            mOptions = new CropImageOptions();
            mOptions.outputUri = outUri;
        }
