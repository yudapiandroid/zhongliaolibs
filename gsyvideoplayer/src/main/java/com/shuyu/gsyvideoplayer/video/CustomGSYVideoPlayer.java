...
public class CustomGSYVideoPlayer extends StandardGSYVideoPlayer {
    ...
    private static final String LOG_TAG = "CustomGSYVideoPlayer";
    ...
    public void onProgressChanged(SeekBar seekBar, final int progress, boolean fromUser) {
        ...
        if(playProgressChange != null){
            playProgressChange.onProgressChange(progress * getDuration() / 100);
        }
    ...
    private PlayProgressChange playProgressChange;

    public void setPlayProgressChange(PlayProgressChange playProgressChange) {
        this.playProgressChange = playProgressChange;
    }

    public interface PlayProgressChange{
